...
void Device_Info(void)
{
	...
	printf("\n");
	printf( "%d - totalGlobalMem:          %d bytes ( %.2f Gbytes)\n" ,device ,(int)deviceProp.totalGlobalMem , deviceProp.totalGlobalMem / (float)( 1024 * 1024 * 1024)  );
	printf( "%d - sharedMemPerBlock:       %d bytes ( %.2f Kbytes)\n" ,device ,(int)deviceProp.sharedMemPerBlock ,deviceProp.sharedMemPerBlock / (float)1024  );
